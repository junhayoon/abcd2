...
const template = `
    <div v-bind:id="droneStationContainerId" class="overflow-hidden border-gray flex-wrap flex-row flex-wrap justify-start items-start" style="height: fit-content; widht:fit-content;">
        <div id="dron_streaming" style="background-image: URL(/static/images/sub_menu_box_top.png); background-size: 100% 100%;"></div>
        <div class="overflow-hidden text-center"><strong style="color:white">드론 이동기지</strong></div>
