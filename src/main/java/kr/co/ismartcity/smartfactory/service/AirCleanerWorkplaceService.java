...
import kr.co.ismartcity.smartfactory.repository.AirCleanerWorkplaceRepository;
...
public class AirCleanerWorkplaceService {
	...
	@Autowired
	private AirCleanerWorkplaceRepository airCleanerWorkplaceRepository;



	public AirCleanerWorkplace addAirCleanerInfo(AirCleanerWorkplace iAirCleanerWorkplace) {
		...
		return airCleanerWorkplaceRepository.save(iAirCleanerWorkplace);
	}
}